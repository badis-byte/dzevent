...
class _SignupState extends State<Signup> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              orDevider(),
              SizedBox(height: 35,),
              buildInput(label: "Full Name", hint: "Enter your full name", pass: false),
              SizedBox(height: 20,),
              buildInput(label: "Email Address", hint: "Enter your email address", pass: false),
              SizedBox(height: 20,),
              buildInput(label: "Password", hint: "Enter your password", pass: true),
              SizedBox(height: 20,),
              buildInput(label: "Confirm Password", hint: "Confirm your password", pass: true),
              SizedBox(height: 30),
              createButton(),
              SizedBox(height: 30),
              policy(),
  ...
  Column buildInput({required String label, required String hint, required bool pass}) {
    return Column(
